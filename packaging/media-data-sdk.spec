...
sqlite3 %{buildroot}/opt/usr/dbspace/.media.db 'PRAGMA journal_mode = PERSIST;
	...
	CREATE TABLE IF NOT EXISTS folder (folder_uuid TEXT PRIMARY KEY, path TEXT NOT NULL UNIQUE, name TEXT NOT NULL, cover_image TEXT, modified_time INTEGER DEFAULT 0, storage_type INTEGER, unique(path, name, storage_type));
	...
	INSERT INTO folder VALUES("baeb79e5-a9da-4667-aeaf-6b98830e4ce8","/opt/usr/media/Images","Images",NULL,1337008628,0);
'
